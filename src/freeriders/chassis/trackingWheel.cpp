...
freeriders::TrackingWheel::TrackingWheel(pros::adi::Encoder* encoder, float wheelDiameter, float distance,
                                     float gearRatio) {
...
freeriders::TrackingWheel::TrackingWheel(pros::Rotation* encoder, float wheelDiameter, float distance, float gearRatio) {
...
freeriders::TrackingWheel::TrackingWheel(pros::MotorGroup* motors, float wheelDiameter, float distance, float rpm) {
    this->motors = motors;
...
void freeriders::TrackingWheel::reset() {
...
float freeriders::TrackingWheel::getDistanceTraveled() {
    if (this->encoder != nullptr) {
        ...
        return freeriders::avg(distances);
    } else {
        return 0;
    }
}

float freeriders::TrackingWheel::getOffset() { return this->distance; }

int freeriders::TrackingWheel::getType() {
