...
class TrackingWheel {
    public:
         ...
         * freeriders::TrackingWheel verticalTrackingWheel(&verticalEncoder, freeriders::Omniwheel::NEW_275, -5);
         ...
         * freeriders::TrackingWheel horizontalTrackingWheel(&horizontalEncoder, freeriders::Omniwheel::OLD_325, -2, 5.0/3.0);
         * @endcode
         */
         ...
         * // the rpm is 360
         * freeriders::TrackingWheel leftTrackingWheel(&leftMotors, freeriders::Omniwheel::OLD_4, -5, 360);
         * @endcode
         */
         ...
         *
         * If you are using odometry provided by freeriders, this will automatically be called when
         ...
         *     freeriders::TrackingWheel exampleTrackingWheel(&exampleEncoder, freeriders::Omniwheel::NEW_275, 0.5);
         ...
         *     freeriders::TrackingWheel exampleTrackingWheel(&exampleRotationSensor, freeriders::Omniwheel::NEW_275, 0.5);
