...
#include "freeriders/asset.hpp"
#include "freeriders/chassis/trackingWheel.hpp"
#include "freeriders/pose.hpp"
#include "freeriders/pid.hpp"
#include "freeriders/exitcondition.hpp"
#include "freeriders/driveCurve.hpp"
...
class OdomSensors {
    public:
         ...
         * freeriders::TrackingWheel vertical1(&vertical_rotation, freeriders::Omniwheel::NEW_275, 0.5);
         * freeriders::OdomSensors sensors(&vertical1, // vertical tracking wheel
...
class ControllerSettings {
    public:
         ...
         * @b Example
         * @code {.cpp}
         * freeriders::ControllerSettings lateralSettings(10, // proportional gain (kP)
...
class Drivetrain {
    public:
         ...
         *
         * freeriders::Drivetrain drivetrain(&leftMotors, // left motor group
         *                               &rightMotors, // right motor group
         *                               10, // 10 inch track width
         *                               freeriders::Omniwheel::NEW_4, // using new 4" omnis
...
class Chassis {
    public:
         ...
         * @code {.cpp}
         * // set the pose of the chassis to x = 0, y = 0, theta = 0
         * freeriders::Pose poseA(0, 0, 0);
         * chassis.setPose(poseA);
         * // set the pose of the chassis to x = 5.3, y = 12.2, theta = 3.14
         * // this time with theta in radians
         * freeriders::Pose poseB(5.3, 12.2, 3.14);
