 ...
 *
 * This is the primary way of interacting with the telemetry portion of freeriders's logging implementation. This sink is
 ...
 * <h3> Example Usage </h3>
 * @code
 * freeriders::telemetrySink()->setLowestLevel(freeriders::Level::INFO);
 * freeriders::telemetrySink()->info("{},{}", motor1.get_temperature(), motor2.get_temperature());
 * @endcode
 */
