...
/**
 * @brief A base for any sink in freeriders to implement.
 *
 * Sinks are freeriders's abstraction for destinations that logged messages can be sent to. They are the backbone of the
...
class BaseSink {
    public:
         ...
         * <h3> Example Usage </h3>
         * @code
         * freeriders::BaseSink combinedSink({freeriders::telemetrySink(), freeriders::infoSink()});
         ...
         * <h3> Example Usage </h3>
         * @code
         * sink.log(freeriders::Level::INFO, "{} from the logger!", "Hello");
         * @endcode
    ...
    protected:
         ...
         * <h3> Example Usage </h3>
         * @code
         * infoSink()->setFormat("[freeriders] -- {time} -- {level}: {Message}");
         * infoSink()->info("hello");
         * // This will be formatted as:
         * // "[freeriders] -- 10 -- INFO:  hello"
         * @endcode
         */
