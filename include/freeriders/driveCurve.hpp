 ...
 * see https://www.vexforum.com/t/expo-drive-freeriderss-implementation for a detailed explanation
 */
class ExpoDriveCurve : public DriveCurve {
    public:
         ...
         * freeriders::ExpoDriveCurve driveCurve(5, 12, 1.132);
         * @endcode
         */
